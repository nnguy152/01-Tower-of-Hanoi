...
var button = document.querySelector('.button') // for game modes
var popup = document.querySelector('.winner') // win text popup

document.onload = startGame() // starts game upon page load
...
// select start block and destination container
